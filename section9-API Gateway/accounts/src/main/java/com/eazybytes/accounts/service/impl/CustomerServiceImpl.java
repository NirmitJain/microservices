...
public class CustomerServiceImpl implements ICustomerService {
    ...
    public CustomerDetailsDto fetchCustomerDetails(String mobileNumber,String correlationId) {
        ...
        CustomerDetailsDto customerDetailsDto = CustomerMapper.mapToCustomerDetailsDTO(existingCustomer, new CustomerDetailsDto());
        customerDetailsDto.setAccountsDto(AccountsMapper.mapToAccountsDto(existingAccount,new AccountsDto()));
